...
export type KIT_ROUTES = {
  PAGES: { '/': never, '/about': never, '/calendar': never, '/cancel': never, '/membership_support': never, '/registration': never, '/success': never }
  SERVERS: Record<string, never>
  ACTIONS: Record<string, never>
  LINKS: { 'skryonline': never, 'google_maps': never, 'stupa': never, 'medicine_buddha': never, 'registration': never, 'success': never, 'cancel': never, 'google_calendar': never, 'membership_support': never }
